...
async function create(to, emails, attachments, object) {
    ...
    let html = "<div style='text-align: center; width: 75%; margin: auto;'>" +
        ...
        "<b>Document en cours d'expiration.</b>" +
        "<p>Chère propriétaire, nous vous notifions qu'un ou plusieurs documents sont en cours d'expiration. Rendez-vous sur votre application mobile pour plus de détails." +
    ...
    const message = {
        ...
        to: to,
        subject: object ? object : "Document en cours s'expiration",
        html: html,
        cc: emails,
