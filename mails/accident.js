...
async function create(to) {
    ...
    let html = "<div style='text-align: center; width: 75%; margin: auto;'>"+
                    ...
                    "<b>Un accident vient d'être signalé sur l'une de vos voitures</b>"+
                    "<p>Chère propriétaire, nous vous notifions qu'un accident vient d'être signé sur l'une de vos voitures. Vous pourvez vous rendre plutars sur l'application pour plus de détails." +
    ...
    const message = {
        ...
        to: to,
        subject: "Déclaration d'accident",
        html: html
    }
