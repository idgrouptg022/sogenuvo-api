...
async function create(to) {
    ...
    let html = "<div style='text-align: center; width: 75%; margin: auto;'>"+
                    ...
                    "<b>Une panne vient d'être signalée sur l'une de vos voitures</b>"+
                    "<p>Chère propriétaire, nous vous notifions qu'une panne vient d'être signalée sur une voiture. Vous pourvez vous rendre plutars sur l'application pour plus de détails." +
