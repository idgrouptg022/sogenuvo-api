...
async function create(to) {
    ...
    let html = "<div style='text-align: center; width: 75%; margin: auto;'>"+
                    ...
                    "<b>Un entretien vient d'être signalé sur l'une de vos voitures</b>"+
                    "<p>Chère propriétaire, nous vous notifions qu'un entretien vient d'être signalé sur une voiture. Vous pourvez vous rendre plutard sur l'application pour plus de détails." +
    ...
    const message = {
        ...
        to: to,
        subject: "Déclaration d'entretien",
        html: html
    }
