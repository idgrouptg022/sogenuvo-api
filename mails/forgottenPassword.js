...
async function confirmation(to, code) {
    ...
    let html = "<div style='text-align: center; width: 75%; margin: auto;'>"+
                    ...
                    "<p>Pour confirmer votre email et pouvoir réinitaliser votre mot de passe, veuillez utiliser le code de confirmation ci-dessous. " +
                    "Il s'agit d'une mesure de sécuritié pour s'assurer de la validité de votre adresse e-mail.</p>" +
